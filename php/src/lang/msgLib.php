<?php
	...
	$msg = array( 
		"en" => array( // 01 english (375 Mio./1500 Mio.) | (USA[G8] <02|2012:245,2Mio->2014:->279,82Mio>, UK[G8] <09|2012:52,72Mio->2014:->57,08Mio>, Canada[G8] <20|2012:?Mio->2014:33Mio>, Irland, Australia, NZ, Südafrika, Nigeria <08|2012:48,27Mio->2014:67,1Mio>)
			...
			"label_company_url" => "Company URL",
			"label_company_name" => "Company Name",
			"label_company_country" => "Country",
			"label_company_city" => "City",
			"label_company_infos" => "Company Infos",
			"label_company_address" => "Street, Post Code",
			"label_company_map_url" => "Map URL",
			"label_company_route_notes" => "Route Notes",
			"label_company_ratings" => "Ratings",
			"label_company_notes" => "Remarks",
			"label_job_position" => "Position Name",
			"label_job_url" => "Job URL",
			"label_job_notes" => "Remarks",
			...
			"list_titel_hot" => "HOT LIST",
			"list_titel_interesting" => "NOT BAD, BUT ..",
			"list_titel_black" => "BLACK LIST",
		),
		...
		"de" => array( // 10 german (105 Mio./185 Mio.) |(Germany[G8] <07|2012:67,48Mio->2014:71,72Mio>)
			...
			"label_company_url" => "URL des Unternehmens",
			"label_company_name" => "Name des Unternehmens",
			"label_company_country" => "Land",
			"label_company_city" => "Stadt",
			"label_company_infos" => "Infos oder Fakten",
			"label_company_address" => "Strasse, Postleitzahl",
			"label_company_map_url" => "Kartenlink",
			"label_company_route_notes" => "Notizen für Anfahrtsweg",
			"label_company_ratings" => "Bewertungen",
			"label_company_notes" => "Bemerkungen",
			"label_job_position" => "Stellenname",
			"label_job_url" => "Job URL",
			"label_job_notes" => "Bemerkungen",
			...
			"list_titel_hot" => "FAVORITEN",
			"list_titel_interesting" => "INTERESSANT, ABER ..",
			"list_titel_black" => "SCHWARZE LISTE"
		),
